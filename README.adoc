...
The Glyph Outline Description (GOD) represents a single glyph. It differentiates between 63 types of strokes, and the position and size information is attributed. The design allows strokes and existing GOD data to be composited to form new GOD data. Precise, composable, that's GOD.
...
https://github.com/smaji-org/smaji_glyph_path[smaji_glyph_path], a library to read, write and translate glyph path files.
